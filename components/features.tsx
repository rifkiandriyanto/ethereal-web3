              ...
              >
                <div>
                  <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                    The Future of Digital Art & Finance
                  </div>
                </div>
                <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-3">
                  Revolutionize Your Creative Assets with Blockchain
                </h3>
                <p className="text-lg text-slate-400 mb-8">
                  Unlock the potential of your digital creations through our
                  cutting-edge NFT marketplace and DeFi platform, bridging the
                  gap between art and finance in the Web3 era.
                </p>
