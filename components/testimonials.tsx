  ...
  const items: Item[] = [
    {
      ...
      quote: "The decentralized identity solution is a game-changer. It gives users control over their data while maintaining security. The seamless integration with our dApp has significantly improved user trust and engagement.",
      name: 'Elena Rodriguez',
      role: 'CTO of DecentralizeMe'
    },
    {
      img: TestimonialImg02,
      quote: "Implementing smart contracts through this platform has streamlined our processes. It automates complex agreements without intermediaries, cutting costs and increasing transparency. It's transforming how we.",
      name: 'Alex Chen',
      role: 'Founder of BlockChain Co'
    },
    {
      img: TestimonialImg03,
      quote: "The tokenization service has revolutionized our real estate business. We can now fractionally tokenize properties, making them accessible to more investors. The liquidity this brings to traditionally illiquid assets is amazing.",
      name: 'Sarah Thompson',
      role: 'CEO of TokenEstate'
    }
  ]
