          ...
          <div className="max-w-3xl mx-auto text-center">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                The decentralized web platform
              </div>
            </div>
            ...
            <p className="text-lg text-slate-400 mb-8">
              Enter the world of decentralized applications, smart contracts,
              and tokenized assets. Take control of your digital identity and
              participate in the new internet economy.
            </p>
            <div>
              <a
