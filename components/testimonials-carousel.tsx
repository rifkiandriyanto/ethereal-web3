  ...
  const carouselItems = [
    {
      ...
      description:
        "Empower users with self-sovereign identity, giving them full control over blockchain.",
    },
    {
      image: CarouselImg02,
      title: "Smart Contracts",
      description:
        "Leverage self-executing contracts with terms directly written into code on the blockchain.",
    },
    {
      image: CarouselImg03,
      title: "Tokenization",
      description:
        "Create and manage digital assets on the blockchain, representing real-world in the ecosystem.",
    },
    {
      image: CarouselImg04,
      title: "Decentralized Governance",
      description:
        "Participate in community-driven decision-making processes through DAOs.",
    },
    {
      image: CarouselImg05,
      title: "Zero-Knowledge Proofs",
      description:
        "Implement privacy-preserving technologies to verify information blockchain.",
    },
  ];
        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Embrace Web3 Technology
            </h2>
            <p className="text-lg text-slate-400">
              Web3 represents the next evolution of the internet, powered by
              blockchain technology, decentralized networks, and token-based
              economics. It promises greater user control, enhanced privacy, and
