  ...
  const features = [
    {
      ...
      description:
        'Empower users with self-sovereign identity, giving them full control over their personal data on the blockchain.',
    },
    {
      icon: (
      ...
      description:
        'Leverage self-executing contracts with the terms of the agreement directly written into code on the blockchain.',
    },
    {
      icon: (
      ...
      title: 'Tokenization',
      description:
        'Create and manage digital assets on the blockchain, representing real-world assets or utility within the ecosystem.',
    },
    {
      icon: (
      ...
      description:
        'Participate in community-driven decision-making processes through decentralized autonomous organizations (DAOs).',
    },
    {
      icon: (
      ...
      description:
        'Utilize distributed file systems like IPFS to store and retrieve data in a decentralized, censorship-resistant manner.',
    },
    {
      icon: (
      ...
      description:
        'Implement privacy-preserving technologies to verify information without revealing sensitive data on the blockchain.',
    },
  ];
                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              ...
                              Leverage blockchain technology for secure,
                              user-controlled digital identities, enabling
                              seamless interactions across decentralized
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Seamlessly interact with decentralized applications
                            through our intuitive smart contract integration,
                            enabling trustless and transparent transactions on
                            the blockchain.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            ...
                            through our decentralized governance model,
                            empowering users to shape the future of the
                            platform.
                          </p>
                        </div>
                      </div>
            ...
            {features.map((feature, index) => (
              <div key={index}>
                <div className="flex items-center space-x-2 mb-1">
                  ...
                  <h4 className="font-medium text-slate-50">{feature.title}</h4>
                </div>
